...
// Extend Leaflet type to include Proj from proj4leaflet
declare module 'leaflet' {
  namespace Proj {
    function CRS(code: string, proj4def: string, options?: any): L.CRS;
  }
}
...
export const crsUtm44n = new (L as any).Proj.CRS('EPSG:32644', utm44nProj4, {
  resolutions: [
