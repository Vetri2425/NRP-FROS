...
const SplineWaypointTool: React.FC<SplineWaypointToolProps> = ({ 
  ...
  const handleConvert = async () => {
    if (currentWaypoints.length === 0) {
      await showAlert("No Waypoints", "No waypoints to convert");
      return;
    }
    ...
    if (convertedCount === 0) {
      await showAlert("Conversion Failed", "No waypoints were converted. Make sure you have WAYPOINT commands selected.");
      return;
    }
